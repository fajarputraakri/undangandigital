    ...
    <div class="container">
      ...
      <ul class="main-menu visible-on-click" id="main-menu">
        <li><a href="index.php">HOME</a></li>
				<li><a href="#sambutan">QUOTE</a></li>
				<li><a href="#ceritaKita">LOVE STORY</a></li>
                ...
                <div class="col-sm-4">
                  <form method="POST" action="log.php">
                    ...
                    <div class="col-sm-12 center-text">
                      <button class="btn" name="login"><b>Login</b></button>
                    </div>  
  ...
  <footer>
    <div class="container center-text" id="sosmed">
      ...
      <p class="copyright"> Copyright &copy;<script>document.write(new Date().getFullYear());</script>
       -  Dibuat dengan <i class="icon-heart" aria-hidden="true"></i> oleh Mohammad Fajar Putra Akri</p>
    </div>
  </footer>
  <!-- end = footer -->
